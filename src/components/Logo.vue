<template lang="pug">
  svg.Header-logo.Logo(v-bind:class="`Logo--${color}`" width="42px" height="35px" viewBox="0 0 42 35" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink")
