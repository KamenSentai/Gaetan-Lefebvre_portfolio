<template lang="pug">
  .Color
    ...
    svg.Color-shape(v-if="shape === 'square'" width="160px" height="160px" viewBox="0 0 160 160" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink")
