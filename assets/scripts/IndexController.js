...
class IndexController extends PageController {
  ...
  enter(el, done) {
    ...
    if (_hero) {
      ...
      TweenLite.fromTo('.Hero-click', 1, { opacity: 0, x: -30 }, { opacity: 1, x: 0, delay: 2, ease: Power2.easeInOut, onComplete: () => {
  ...
  leave(el, done) {
    ...
    if (_hero) {
      ...
      TweenLite.fromTo('.Hero-click', 1, { opacity: 1, x: 0 }, { opacity: 0, x: 30, delay: .5, ease: Power2.easeInOut })
