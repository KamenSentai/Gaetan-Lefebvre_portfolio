...
.Slider(data-aos="fade-left" v-bind:class="automatic ? 'Slider--automatic' : ''")
  ...
  .Slider-content(v-if="mockup" @touchstart="touchStart" @touchmove="touchMove" ref="content")
    ...
    .Slider-images
      img.Slider-image.Shadow--image(v-for="image in images" :src="require(`~/assets/images/${folder}/${image.src}.png`)" v-lazy="require(`~/assets/images/${folder}/${image.src}.png`)" :alt="image.alt" ref="images")
