...
.Slider(data-aos="fade-left" v-bind:class="automatic ? 'Slider--automatic' : ''")
  ...
  .Slider-content(v-if="mockup" @touchstart="touchStart" @touchmove="touchMove" ref="content")
    img.Slider-mockup(:src="require(`../assets/images/${folder}/${mockup.src}.png`)" :alt="mockup.alt" draggable="false")
    .Slider-images
  ...
  .Slider-images.Slider-images--pushed(v-else @touchstart="touchStart" @touchmove="touchMove")
    img.Slider-image.Shadow(v-for="image in images" :src="require(`../assets/images/${folder}/${image.src}.png`)" :alt="image.alt" ref="images")
