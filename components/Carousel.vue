    ...
    .Carousel-content(v-bind:class="isMenu ? 'is-hidden': ''")
      ...
      .Content-group
        nuxt-link.Carousel-item.Cursor-frame--text(v-if="!slide" v-bind:class="`Carousel-item--${modulo(range - 1, 4)}`" :to="{ name: 'projects-tesla', params: { from: $route.name } }")
          .Carousel-image
            img.Carousel-layer.Carousel-layer--back(src="../static/images/Projects/tesla_back.png" alt="Tesla")
            Glitch.Carousel-neon(
              path="static/images/Projects/"
              image="tesla"
              alt="Tesla"
      ...
      .Content-group
        nuxt-link.Carousel-item.Cursor-frame--text(v-if="!slide" v-bind:class="`Carousel-item--${modulo(range - 2, 4)}`" :to="{ name: 'projects-buddy-buddy', params: { from: $route.name } }")
          .Carousel-image
            img.Carousel-layer.Carousel-layer--back(src="../static/images/Projects/buddy-buddy_back.png" alt="Buddy Buddy")
            Glitch.Carousel-neon(
              path="static/images/Projects/"
              image="buddy-buddy"
              alt="Buddy Buddy"
      ...
      .Content-group
        span.Carousel-item.Carousel-item--forbidden(v-if="!slide || parseInt(slide) === 3" v-bind:class="`Carousel-item--${modulo(range - 3, 4)}`")
          .Carousel-image
            img.Carousel-layer.Carousel-layer--back(src="../static/images/Projects/personal_back.png" alt="Personal")
            Glitch.Carousel-neon(
              path="static/images/Projects/"
              image="personal"
              alt="Personal"
