      ...
      .Carousel-group
        ...
        .Carousel-item(v-else-if="parseInt(slide) === 0" data-index="0")
          .Carousel-image
            ...
            img.Carousel-neon(src="~assets/images/Projects/pocketcare.png" alt="Pocketcare neon visual" draggable="false")
      ...
      .Carousel-group
        ...
        .Carousel-item(v-else-if="parseInt(slide) === 1" data-index="0")
          .Carousel-image
            ...
            img.Carousel-neon(src="~assets/images/Projects/tesla.png" alt="Tesla neon visual" draggable="false")
      ...
      .Carousel-group
        ...
        .Carousel-item(v-else-if="parseInt(slide) === 2" data-index="0")
          .Carousel-image
            ...
            img.Carousel-neon(src="~assets/images/Projects/buddy-buddy.png" alt="Buddy Buddy neon visual" draggable="false")
