...
.Mouse(v-bind:class="state")
  .Mouse-frame(ref="frame")
    .Mouse-hud(ref="hud")
      .Mouse-group
        img.Mouse-text(v-if="$route.name && $route.name === 'projects'" src="~assets/images/Mouse/more.png" alt="See more")
        img.Mouse-text(v-else-if="$route.name && $route.name.includes('projects-')" src="~assets/images/Mouse/next.png" alt="Next project")
