...
.Mouse(v-bind:class="state")
  .Mouse-frame(ref="frame")
    .Mouse-hud(ref="hud")
      .Mouse-group
        img.Mouse-text(v-if="$route.name && $route.name === 'projects'" v-lazy="require('~/assets/images/Mouse/more.png')" alt="See more")
        img.Mouse-text(v-else-if="$route.name && $route.name.includes('projects-')" v-lazy="require('~/assets/images/Mouse/next.png')" alt="Next project")
  svg.Mouse-pointer(ref="pointer" width="40px" height="40px" viewBox="0 0 40 40")
    ...
    path#Mouse-square.Mouse-shape(d="M38.8,1.2v37.5H20H1.2V1.2H38.8z")
